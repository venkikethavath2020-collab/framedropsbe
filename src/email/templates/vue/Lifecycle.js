  ...
  switch (variant) {
    ...
    case 'quota_80_pct':
      return {
        ...
        bodyParagraphs: [
          `Once you cross the free quota, new albums move to per-album pricing — ₹49 for up to 1,000 photos, ₹99 up to 2,000, ₹149 up to 3,000. There's no monthly fee; you only pay when you publish.`,
